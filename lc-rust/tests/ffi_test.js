...
t('HTML', (compiler) => {
    assert.equal(
        ...
        '<span data-lc-start="0b0000000000000001" data-lc-end="0b0000000000000010">x => </span><span data-lc-start="0b0000000000000011" data-lc-end="0b0000000000000100">x</span>'
    );
});
